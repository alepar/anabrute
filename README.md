...
Probing cruncher backends:
  ...
  avx2: skipped (GPU backend active)
  cpu: skipped (GPU backend active)
1 cruncher instance(s) total
...
```
Probing cruncher backends:
  opencl[0]: NVIDIA GeForce RTX 5070 Laptop GPU
  opencl: 1 instance(s)
  avx512: skipped (GPU backend active)
  avx2: skipped (GPU backend active)
  cpu: skipped (GPU backend active)
...
a3d7911494e1fdabd394e6980efaa63a:  ail no or put st st ty wu
  ...
  opencl(1): 9.9T anas, 3.8GAna/s avg
  total: 9.9T anas in 2881.3s, 3.8GAna/s effective
```
